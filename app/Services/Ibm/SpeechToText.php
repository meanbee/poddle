...
class SpeechToText extends Ibm
{
    ...
    const IBM_URL = 'https://stream.watsonplatform.net/speech-to-text/api/';
     ...
     * @return $this
     */
    public function recognize($fileName, $contentType = self::CONTENT_TYPE, $uri = false)
    {
